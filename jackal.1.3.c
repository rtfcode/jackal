...
** v1.3 - 25/1/2018
**
** Edited the comments and display messages to reflect the version number correctly.
**
** v1.2 - 6/12/2017
**
** (Hopefully) (working) support for OpenSSL 1.1.0.
**
** v1.1 - 24/10/2017
**
** Attempt at port to OpenSSL 1.1.0.  (This didn't really work very well.)
**
** v1.0 - 8/11/2014
**
...
int main(int argc, char *argv[])
{
	...
	printf("Jackal v1.3 - Certificate Cloner - K Sheldrake\n");
	printf("----------------------------------------------\n\n");
    ...
    printf("rtfc.org.uk / github/rtfcode/jackal\n\n\n");
